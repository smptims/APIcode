...
(function () {
    ...
    const table = require('./tables/adminSms');
    ...
    module.exports = function (express, app) {
        console.log('adminSmsController');
        //logger.debug('Debugging info');
        var adminSmsRouter = express.Router();
        app.use('/adminSmsapi', adminSmsRouter);

        app.get('/adminSmsapi/adminSms', function (req, res, next) {
            //get data from mongosql and pass it to view
            console.log("hello : /adminSms");
        ...
        adminSmsRouter.use(tracer.localLog);
        console.log('calling adminUsers controller');
        return baseControllersql(adminSmsRouter, sql, table, 'adminSms', logger);
    };
})();